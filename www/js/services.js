...
.factory("detailData",function(){ //商品详情页 - 基本信息
	obj=[
		...
		[{
			...
			price:"90",
			imgsrc:"img/product/8.png",
			detailedImg:"img/detailsimg/8.jpg"
		}]
	]
	return obj;
})
.factory("pickData",function(){ //商品详情页 - 规格选择
	obj=[
		[
			{title:"5-7cm (500/盒)", price:298},
			{title:"5-7cm (1000/盒)", price:538},
			{title:"7-10cm (500/盒)", price:378},
			{title:"7-10cm (1000/盒)", price:628},
			{title:"10+cm (500/盒)", price:428},
			{title:"10+cm (1000/盒)", price:668}
		],[
			{title:"老母鸡(1000g/只)", price:188},
			{title:"小母鸡(1000g/只)", price:168},
			{title:"一年期阉公鸡(1500g/只)", price:328},
			{title:"十个月阉公鸡(1500g/只)", price:302},
			{title:"八个月阉公鸡(1500g/只)", price:288},
			{title:"六个月阉公鸡(1000g/只)", price:198}
		],
	]
	return obj;
})
